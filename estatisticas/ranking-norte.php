...
/* =========================================
   DADOS DO RANKING NORTE
========================================= */

$paginaAtual = 'norte';

$configRegiao = $REGIOES_RANKING['norte'];
        ...
        <div class="ranking-container">
            ...
            <?php
                renderHeroRanking(
                    'Ranking Regional',
                    $configRegiao['titulo'],
                    'Classificação dos clubes nortistas em atividade, considerando a pontuação acumulada em competições internacionais, nacionais, regionais e estaduais.',
                    [
            ...
            <section class="card-tabela-ranking">
                ...
                <?php if (!empty($ranking)): ?>
                    ...
                    ?>
                <?php else: ?>
                    <?php renderMensagemVaziaRanking('Nenhum clube foi encontrado para composição do ranking do Norte.'); ?>
                <?php endif; ?>
            </section>
