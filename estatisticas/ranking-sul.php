...
/* =========================================
   DADOS DO RANKING SUL
========================================= */

$paginaAtual = 'sul';

$configRegiao = $REGIOES_RANKING['sul'];
        ...
        <div class="ranking-container">
            ...
            <?php
                renderHeroRanking(
                    'Ranking Regional',
                    $configRegiao['titulo'],
                    'Classificação dos clubes do Sul em atividade, considerando a pontuação acumulada em competições internacionais, nacionais, regionais e estaduais.',
                    [
            ...
            <section class="card-tabela-ranking">
                ...
                <?php if (!empty($ranking)): ?>
                    ...
                    ?>
                <?php else: ?>
                    <?php renderMensagemVaziaRanking('Nenhum clube foi encontrado para composição do ranking do Sul.'); ?>
                <?php endif; ?>
            </section>
