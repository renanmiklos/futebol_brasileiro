...
/* =========================================
   DADOS DO RANKING INTERNACIONAL
========================================= */

$paginaAtual = 'internacional';
...
$tituloPagina = 'Ranking Internacional dos Clubes - Futebol Brasileiro';
?>
        ...
        <div class="ranking-container">
            ...
            <?php
                renderHeroRanking(
                    ...
                    'Ranking Internacional dos Clubes',
                    'Classificação dos clubes brasileiros considerando apenas a pontuação acumulada em competições internacionais, continentais e mundiais.',
                    [
            ...
            <section class="card-tabela-ranking">
                <div class="titulo-bloco-ranking">
                    ...
                    <span>Ranking internacional</span>
                </div>
                ...
                <?php if (!empty($ranking)): ?>
                    ...
                    ?>
                <?php else: ?>
                    <?php renderMensagemVaziaRanking('Nenhum clube foi encontrado para composição do ranking internacional.'); ?>
                <?php endif; ?>
            </section>
