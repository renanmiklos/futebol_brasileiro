...
/* =========================================
   DADOS DO RANKING SUDESTE
========================================= */

$paginaAtual = 'sudeste';

$configRegiao = $REGIOES_RANKING['sudeste'];
        ...
        <div class="ranking-container">
            ...
            <?php
                renderHeroRanking(
                    'Ranking Regional',
                    $configRegiao['titulo'],
                    'Classificação dos clubes do Sudeste em atividade, considerando a pontuação acumulada em competições internacionais, nacionais, regionais e estaduais.',
                    [
            ...
            <section class="card-tabela-ranking">
                ...
                <?php if (!empty($ranking)): ?>
                    ...
                    ?>
                <?php else: ?>
                    <?php renderMensagemVaziaRanking('Nenhum clube foi encontrado para composição do ranking do Sudeste.'); ?>
                <?php endif; ?>
            </section>
