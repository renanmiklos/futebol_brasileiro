...
/* =========================================
   DADOS DO RANKING NACIONAL
========================================= */

$paginaAtual = 'nacional';

$ranking = gerarRankingPorCompeticoes(
    $pdo,
...
$tituloPagina = 'Ranking Nacional dos Clubes - Futebol Brasileiro';
?>
        ...
        <div class="ranking-container">
            ...
            <?php
                renderHeroRanking(
                    ...
                    'Classificação dos clubes brasileiros considerando apenas a pontuação acumulada em competições nacionais, como Taça Brasil, Robertão, Campeonato Brasileiro, Copa do Brasil e demais torneios nacionais.',
                    [
            ...
            <section class="card-tabela-ranking">
                ...
                <?php if (!empty($ranking)): ?>
                    ...
                    ?>
                <?php else: ?>
                    <?php renderMensagemVaziaRanking('Nenhum clube foi encontrado para composição do ranking nacional.'); ?>
                <?php endif; ?>
            </section>
