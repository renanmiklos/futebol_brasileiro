...
/* =========================================
   DADOS DO RANKING CENTRO-OESTE
========================================= */

$paginaAtual = 'centro-oeste';

$configRegiao = $REGIOES_RANKING['centro-oeste'];

$ranking = gerarRankingPorRegiao(
    $pdo,
    $configRegiao['estados']
);

$totalClubesRanking = count($ranking);
$ultimaAtualizacao = obterUltimaAtualizacaoRanking($pdo);

$tituloPagina = $configRegiao['titulo'] . ' - Futebol Brasileiro';
?>
        ...
        <div class="ranking-container">
            ...
            <?php
                renderHeroRanking(
                    'Ranking Regional',
                    $configRegiao['titulo'],
                    'Classificação dos clubes do Centro-Oeste em atividade, considerando a pontuação acumulada em competições internacionais, nacionais, regionais e estaduais.',
                    [
                        $totalClubesRanking . ' clubes',
                        'Estados: ' . implode(', ', $configRegiao['estados']),
            ...
            <section class="card-tabela-ranking">
                ...
                <?php if (!empty($ranking)): ?>
                    ...
                    ?>
                <?php else: ?>
                    <?php renderMensagemVaziaRanking('Nenhum clube foi encontrado para composição do ranking do Centro-Oeste.'); ?>
                <?php endif; ?>
            </section>
