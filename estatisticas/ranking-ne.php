...
/* =========================================
   DADOS DO RANKING NORDESTE
========================================= */

$paginaAtual = 'nordeste';

$configRegiao = $REGIOES_RANKING['nordeste'];
        ...
        <div class="ranking-container">
            ...
            <?php
                renderHeroRanking(
                    'Ranking Regional',
                    $configRegiao['titulo'],
                    'Classificação dos clubes nordestinos em atividade, considerando a pontuação acumulada em competições internacionais, nacionais, regionais e estaduais.',
                    [
            ...
            <section class="card-tabela-ranking">
                ...
                <?php if (!empty($ranking)): ?>
                    ...
                    ?>
                <?php else: ?>
                    <?php renderMensagemVaziaRanking('Nenhum clube foi encontrado para composição do ranking do Nordeste.'); ?>
                <?php endif; ?>
            </section>
